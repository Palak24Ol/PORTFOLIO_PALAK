...
const Hero: React.FC = () => {
  ...
  const socialLinks = [
    { icon: Github, url: "https://github.com/Palak24Ol" },
    { icon: Linkedin, url: "https://www.linkedin.com/in/palakjaiswal2401/" }
      ...
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            >
              I'm a Computer Science student at NIT Patna, passionate about building AI-powered applications, 
              full-stack platforms, and creating meaningful digital experiences.
            </motion.p>
